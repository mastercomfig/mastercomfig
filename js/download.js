...
function app() {
  ...
  var addons = ["no-extra-models", "no-footsteps", "disable-pyroland", "no-soundscapes", "no-tutorial", "null-cancelling-movement", "flat-mouse", "transparent-viewmodels", "experimental", "badgpu", "lowmem"];
