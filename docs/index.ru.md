...
Добро пожаловать в [mastercomfig](https://comfig.app), современную структуру кастомизации.

Цель mastercomfig — отключить сильно неоптимизированные функции и настроить другие параметры там, где это не оказывает заметного влияния на поведение или визуальные эффекты. mastercomfig подробно задокументирован, а также имеет расширенные функции настройки, позволяющие настраивать параметры в соответствии со своими потребностями/предпочтениями.
