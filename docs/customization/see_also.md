...
!!! info
    ...
    The yttrium's viewmodels installer will add an `autoexec.cfg` inside of your `tf/cfg` folder. That file is not needed (you can delete it if you want to) and you should use the **`dynamic_background=preload`** module instead.
