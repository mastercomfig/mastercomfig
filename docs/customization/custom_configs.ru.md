...
Эти псевдонимы используются mastercomfig для применения сетевых настроек для каждого класса (как указано ниже) при использовании уровня модуля `snapshot_buffer=automatic`.
