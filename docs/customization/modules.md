...
- **`ragdolls=low`**: Enables standard ragdolls with physics.
- **`ragdolls=high`**: Enables ragdolls with collisions, high fade-out time, and special animations such as decapitations.
