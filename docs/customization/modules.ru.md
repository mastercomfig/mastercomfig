...
!!! Предупреждение
    Фильтрация текстур будет работать только при `textures=low` и выше.
...
Настройка по умолчанию: **`sheens_speed=medium`** (все пресеты, кроме Very Low).
...
* **`textures=ultra`**: Максимальное качество текстур.
