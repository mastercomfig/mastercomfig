...
Настройка по умолчанию: **`sourcetv=on`** (все песеты, *включая None*).
...
Настройка по умолчанию: **`packet_rate=standard`** (все пресеты, *включая None*, кроме Very Low).
...
Настройка по умолчанию: **`snapshot_buffer=low`** (все пресеты, *включая None*).
...
* **Использование ГП:** никзое
* **Использование ГП:** отсутсвует

Настройка по умолчанию: **`packet_size = speed`** (все пресеты, *включая None*).
...
Настройка по умолчанию: **`bandwidth=762Kbps`** (все пресеты, *включая None*).
...
Настройка по умолчанию: **`download=auto`** (все пресеты, *включая None*).
...
Настройка по умолчанию: в зависимости от того, какой пресет вы используете в данный момент. *Не установлен в None.*
