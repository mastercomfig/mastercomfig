...
gl_bufmode                               : 1        :                  :
gl_can_query_fast                        : 1        :                  :
gl_can_resolve_flipped                   : 0        :                  :
gl_cannot_resolve_flipped                : 0        :                  :
gl_clear                                 : 0        : , "cl"           :
gl_clear_randomcolor                     : 0        : , "cheat", "cl"  : Clear the back buffer to random colors every frame. Helps spot open seams in geometry.
gl_debug_output                          : 1        :                  :
gl_disable_forced_vsync                  : 0        :                  :
gl_dump_stats                            : cmd      :                  :
gl_enabletexsubimage                     : 1        :                  :
gl_finish                                : 0        :                  :
gl_flushpaircache                        : 0        :                  :
gl_magnify_resolve_mode                  : 2        :                  :
gl_minify_resolve_mode                   : 1        :                  :
gl_minimize_all_tex                      : 1        :                  :
gl_minimize_rt_tex                       : 0        :                  :
gl_minimize_tex_log                      : 0        :                  :
gl_mtglflush_at_tof                      : 0        :                  :
gl_nullqueries                           : 0        :                  :
gl_paircache_rows_lg2                    : 10       :                  :
gl_paircache_ways_lg2                    : 5        :                  :
gl_paircachestats                        : 0        :                  :
gl_persistent_buffer_max_offset          : cmd      :                  :
gl_pow2_tempmem                          : 0        :                  : If set, use power-of-two allocations for temporary texture memory during uploads. May help with fragmentation on certain systems caused by heavy churn of large allocations.
gl_radar7954721_workaround_all           : 0        :                  :
gl_radar7954721_workaround_maskval       : 0        :                  :
gl_radar7954721_workaround_mixed         : 1        :                  :
gl_rt_forcergba                          : 1        :                  :
gl_shader_compile_time_dump              : cmd      :                  : Dump  stats shader compile time.
gl_shaderpair_cachelog                   : 0        :                  :
gl_swapdebug                             : 0        :                  :
gl_swapinterval                          : 0        :                  :
gl_swaplimit                             : 0        :                  :
gl_swaplimit_mt                          : 3        :                  :
gl_swaptear                              : 1        :                  :
gl_telemetry_gpu                         : 0        :                  :
gl_telemetry_gpu_pipeline_flushing       : 0        :                  :
gl_texlayoutstats                        : 0        :                  :
gl_texmsaalog                            : 0        :                  :
glm_literefresh_capslock                 : 0        :                  :
glm_nullrefresh_capslock                 : 0        :                  :
...
grab_window                              : cmd      :                  : grab/ungrab window.
+graph                                   : cmd      :                  :
-graph                                   : cmd      :                  :
-grenade1                                : cmd      :                  :
+grenade1                                : cmd      :                  :
...
mat_autoload_glshaders                   : 1        :                  :
mat_autosave_glshaders                   : 1        :                  :
...
--------------
3648 total convars/concommands
```
