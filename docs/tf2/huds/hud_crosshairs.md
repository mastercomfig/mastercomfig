...
_Originally posted by omnibombulator on huds.tf, images and formatting coming soon_

This guide has been ported over from the old HUDS.TF Guides section. Credit for this Guide goes towards Komorebi.

## Introduction

This part of the tutorial is a basic overview of what exactly a HUD crosshair is. More advanced users should skip ahead to Implementation.
...
### Image
    ...
    *name of your file* needs to be the same as the name of the .vmt and the .vtf, to clarify.
    Create a copy of both files and move the copies into custom/ *any name*/materials/vgui/replay/thumbnails.
    Either create the control in HudLayout.res if you want to use the crosshair that way or reference it in console as an in-game crosshair. If you wish to pursue the second option then skip ahead to In-Game Image Crosshair.
