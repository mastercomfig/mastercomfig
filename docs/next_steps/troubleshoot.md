...
According to the [Official FAQ](https://www.teamfortress.com/meetyourmatch/faq/), Competitive Mode requires DirectX 9. Make sure your `dxlevel` is set to 90 or above (see [here](https://docs.mastercomfig.com/en/latest/customization/launch_options/#dxlevel-launch-options) for instructions).
