...
8. Set these launch options: `-novid -nojoy -nosteamcontroller -nohltv -particles 1 -NoQueuedPacketThread`. For more information, read the [launch options customization guide](../customization/launch_options.md).
