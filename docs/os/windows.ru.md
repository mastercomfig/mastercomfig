...
## Включите режим низкой задержки Nvidia

Nvidia позволяет оптимизировать задержку на уровне драйвера, что может улучшить задержку ввода.
Таким образом, рекомендуется установить режим Low Latency Mode в Nvidia App Graphics Global Settings на `Ультра`.
