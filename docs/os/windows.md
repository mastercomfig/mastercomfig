...
A new feature in Windows 10 May 2020 Update (version 2020) is hardware-accelerated GPU scheduling, which lets the GPU handle its own memory instead of Windows,
