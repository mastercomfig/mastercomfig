...
A feature in Windows 10 1903 update and above is Variable refresh rate (VRR). VRR is the exact same thing as G-Sync or Freesync, which gets your refresh rate to fluctuate with your framerate, removing screen tearing and nullifying the use of VSync, a more archaeic technology which limits your framerate to your refresh rate to remove screen tearing, but at an increase in latency.
