...
A feature in Windows 10 1903 update and above is Variable refresh rate (VRR). VRR attempts to do the same thing as G-Sync or Freesync, which is to get your refresh rate to fluctuate with your framerate, removing screen tearing and nullifying the use of VSync, a more archaic technology which limits your framerate to your refresh rate to remove screen tearing, but at an increase in latency.
